...
/* The code snippet `const usersApi = axios.create({baseURL: "https://login-and-register-wrn2.onrender.com/login/api/v1/",})`
is creating an Axios instance named `usersApi`. This instance is configured with a base URL of
"https://login-and-register-wrn2.onrender.com/login/api/v1/". */
const usersApi = axios.create({
	baseURL: "https://login-and-register-wrn2.onrender.com/login/api/v1/",
})
