...
/* The code snippet `const usersApi = axios.create({baseURL: "http://localhost:8000/login/api/v1/",})`
is creating an Axios instance named `usersApi`. This instance is configured with a base URL of
"http://localhost:8000/login/api/v1/". */
const usersApi = axios.create({
	baseURL: "https://login-and-register-wrn2.onrender.com/",
})
